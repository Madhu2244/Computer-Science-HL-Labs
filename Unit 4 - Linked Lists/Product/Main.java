class Main 
{
  public static void main(String[] args) 
  {
    ...
    ProductList list = new ProductList();
		...
		/**  WHEN ABOVE WORKS, UNCOMMENT A FEW MORE TEST 
		 * UNTIL you have all test cases working
		 * 
		list.clear();
		System.out.println("\n\nSECTION 2:");
		...
		list.set(3,new Product("alfredo sauce",4.26,2));
		list.set(1,new Product("mango",1.80,2));
		System.out.println(list);
		try
		{
